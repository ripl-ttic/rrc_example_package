...
from trifinger_env.simulation import camera
from trifinger_env.simulation.code.utils import sample_cube_surface_points, apply_transform, VisualMarkers, is_valid_action, action_type_to
...
from trifinger_env.simulation import collision_objects
import cv2
import copy
import functools

from trifinger_env.simulation.code.align_rotation import align_rotation
from trifinger_env.simulation.code.const import EXCEP_MSSG
...
class ResidualLearningFCWrapper(gym.Wrapper):
    ...
    def __init__(self, env, apply_torques, evaluation=False, is_level_4=False):
        super().__init__(env)
        from trifinger_env.simulation.code.cube_manipulator import CubeManipulator
        from trifinger_env.simulation.code.fc_force_control import Viz
        ...
        from trifinger_env.simulation.code.fc_force_control import ForceControlPolicy
    ...
    def _tighten_grasp(self, obs, grasp_force=0.8):
        from trifinger_env.simulation.code.fc_force_control import grasp_force_control
...
class ResidualLearningMotionPlanningFCWrapper(gym.Wrapper):
    ...
    def __init__(self, env, apply_torques, action_repeat=2, align_goal_ori=True,
        ...
        super().__init__(env)
        from trifinger_env.simulation.code.fc_force_control import ForceControlPolicy, Viz
        from trifinger_env.simulation.code.cube_manipulator import CubeManipulator
        from trifinger_env.simulation.code.const import MU
    ...
    def _instantiate_planning_fc_policy(self, obs):
        from trifinger_env.simulation.code.fc_planned_motion import PlanningAndForceControlPolicy
