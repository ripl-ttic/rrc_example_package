...
class ScriptedActions:
    def __init__(self, env, cube_tip_positions, orientation=None):
        self.env = env
    ...
    def add_grasp(self, obs, coef=0.9, vis_markers=None):
        ...
        tip_pos_sequence = utils.complete_keypoints(self.ik_utils, self.get_last_tippos(obs), target_tip_positions, unit_length=0.004, vis_markers=vis_markers)
