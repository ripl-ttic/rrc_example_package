...
from code.utils import apply_transform, VisualCubeOrientation, set_seed
...
def run_episode(args):
    ...
    from code.save_video import merge_videos
    from code.env.wrappers import RenderWrapper
...
if __name__ == '__main__':
    from code.save_video import remove_temp_dir
    import argparse
